...
import { getChamas, createChama, updateChama, rotateMerryGoRound, getMyChama, getChamaById, getChamaMembers, getChamaTableBanking, chamaDeposit, chamaPenalty, assignChamaOfficial, addMemberToChama } from '../controllers/chamas';
...
router.put('/:id/officials', requireRole(['TCM_SUPER_ADMIN', 'CHAMA_ADMIN']), assignChamaOfficial);
router.post('/:id/members', requireRole(['TCM_SUPER_ADMIN', 'CHAMA_ADMIN']), addMemberToChama);
