...
export declare const assignChamaOfficial: (req: Request, res: Response) => Promise<any>;
export declare const addMemberToChama: (req: Request, res: Response) => Promise<any>;
...
export declare const getChamaById: (req: Request, res: Response) => Promise<any>;
